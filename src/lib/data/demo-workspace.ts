...
export function getDemoWorkspaceData(
  ...
  const teacher: UserSummary = {
    ...
    handle: "annamercer",
    email: "anna.mercer@classloop.edu",
    avatarUrl: null,
    role: "teacher",
  ...
  const studentThree: UserSummary = {
    ...
    fullName: "Omar Lewis",
    handle: "omar",
    email: "omar.lewis@classloop.edu",
    avatarUrl: null,
    role: "student",
  ...
  return {
    ...
    resources: [
      ...
      },
      {
        ...
        linkUrl: "https://classloop.edu/resources/microscope-reference",
      ...
      },
      {
        ...
        linkUrl: "https://classloop.edu/calendar",
